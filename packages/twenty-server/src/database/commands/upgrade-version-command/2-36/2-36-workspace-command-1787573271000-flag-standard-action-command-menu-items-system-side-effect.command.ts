...
import { invalidateCommandMenuItemReownCache } from 'src/database/commands/upgrade-version-command/2-36/utils/invalidate-command-menu-item-reown-cache.util';
...
@RegisteredWorkspaceCommand('2.36.0', 1787573271000)
@Command({
  name: 'upgrade:2-36:flag-standard-action-command-menu-items-system-side-effect',
  description:
